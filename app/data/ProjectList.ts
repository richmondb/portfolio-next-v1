...
export const ProjectList: projectType[] = [{
    ...
    description: ' SnipURL is a URL shortening service that allows users to effortlessly shorten their URLs and share them anywhere. It makes link sharing simple, fast, and effective.',
    languages: ['NextJs', 'Tailwind', 'NeonDB','BetterAuth', 'HeadlessUI', 'Sonner'],
}];