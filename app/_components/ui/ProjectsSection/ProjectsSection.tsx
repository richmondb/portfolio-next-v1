...
function ProjectsSection() {
  return (
    <div className="relative my-4 lg:my-8 py-8 lg:py-16 ">
      <div className={" w-full pb-12 flex flex-row items-center"}>
        ...
        <div className="relative w-fit p-1 px-2 rounded bg-[rgba(255,255,255,0.1)] backdrop-blur-sm">
          ...
          <div className="w-[120px] h-[120px] bg-violet-600 rounded-full absolute -top-8 filter blur-3xl opacity-20 -z-10"></div>
        </div>
      </div>
